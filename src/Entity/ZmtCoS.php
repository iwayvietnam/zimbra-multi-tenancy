...
/**
 * Defines the Class of Service entity.
 *
 * @ingroup zmt
 *
 * @ContentEntityType(
 *   id = "zmt_cos",
 *   label = @Translation("Class of Service"),
 *   handlers = {
...
class ZmtCoS extends ContentEntityBase implements ZmtCoSInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Class of Service entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Class of Service entity.'))
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
      ])
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Class of Service is published.'))
